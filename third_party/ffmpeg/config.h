...
#define FFMPEG_CONFIGURATION "--cross-compile --cross-prefix=psp- --arch=mips --target-os=linux --extra-cflags=-Wno-error=incompatible-pointer-types -Wno-error=implicit-function-declaration -fno-strict-aliasing -G0 -I/home/gianni/Desktop/PSP/workplace/re/vendor-sources/faad2-2.7/include --extra-ldflags=-L/home/gianni/Desktop/PSP/workplace/re/vendor-sources/faad2-2.7/libfaad/.libs --enable-gpl --enable-libfaad --disable-encoders --disable-muxers --disable-decoders --enable-decoder=h263 --enable-decoder=flv --enable-decoder=mp3 --enable-decoder=h264 --enable-decoder=mpeg4aac --disable-demuxers --enable-demuxer=flv --enable-demuxer=mov --disable-protocols --enable-protocol=file --disable-network --disable-debug --disable-ffserver --disable-ffplay --disable-ffmpeg"
